...
class FileTypeDetector:
    ...
    MAGIC_BYTES = {
        ...
        b'\xD0\xCF\x11\xE0\xA1\xB1\x1A\xE1': ('document', 'application/msword'),  # DOC/XLS/PPT
    ...
    MIME_CATEGORIES = {
        'text': [
            ...
            'text/xml', 'text/csv', 'text/markdown', 'text/x-python',
            'text/x-java', 'text/x-c', 'text/x-c++', 'text/x-csharp',
    ...
    @classmethod
    def detect(cls, filename: str, file_content: bytes = None, mime_hint: str = None) -> dict:
        """
        综合检测文件类型
